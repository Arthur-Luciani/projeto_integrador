...
insert into venda (data_venda, comissao_vendedor, lucro, id_cliente, id_usuario) values ('2021-09-30', 67.59, 518.19, 1, 22);
insert into venda (data_venda, comissao_vendedor, lucro, id_cliente, id_usuario) values ('2022-09-05', 78.03, 970.79, 2, 23);
insert into venda (data_venda, comissao_vendedor, lucro, id_cliente, id_usuario) values ('2021-11-29', 65.91, 730.95, 3, 24);
insert into venda (data_venda, comissao_vendedor, lucro, id_cliente, id_usuario) values ('2022-06-04', 66.03, 564.68, 4, 25);
insert into venda (data_venda, comissao_vendedor, lucro, id_cliente, id_usuario) values ('2022-03-24', 83.85, 319.45, 5, 26);
insert into venda (data_venda, comissao_vendedor, lucro, id_cliente, id_usuario) values ('2021-07-26', 65.36, 335.84, 6, 27);
insert into venda (data_venda, comissao_vendedor, lucro, id_cliente, id_usuario) values ('2022-04-16', 83.42, 127.97, 7, 28);
insert into venda (data_venda, comissao_vendedor, lucro, id_cliente, id_usuario) values ('2022-06-01', 11.28, 390.35, 8, 29);
insert into venda (data_venda, comissao_vendedor, lucro, id_cliente, id_usuario) values ('2022-02-28', 58.29, 800.48, 9, 30);
insert into venda (data_venda, comissao_vendedor, lucro, id_cliente, id_usuario) values ('2022-09-13', 30.17, 233.89, 10, 31);
